...
import com.example.ebreadshop.menuManagement.FoodListActivity;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signinbtn = (Button) findViewById(R.id.bsign);
        InputUsername = (EditText) findViewById(R.id.signnm);
        InputPassword = (EditText) findViewById(R.id.signpwd);
             ...
             if (dataSnapshot.child(parentDbName).child(name).exists())
             {
                 ...
                 if(usersData.getName().equals(name))
                 {
                     if(usersData.getPassword().equals(password))
                     {
                         ...
                         Intent intent = new Intent(SignInActivity.this, FoodListActivity.class);
                         startActivity(intent);
                     }
                 }
             }
