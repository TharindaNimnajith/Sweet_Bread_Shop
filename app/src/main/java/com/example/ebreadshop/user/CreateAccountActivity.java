...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup = (Button) findViewById(R.id.accbtnreg);
        inputUname = (EditText) findViewById(R.id.accuname);
        inputEmail = (EditText) findViewById(R.id.accemail);
        inputPassword = (EditText) findViewById(R.id.accpwd);
        inputrpassword = (EditText) findViewById(R.id.accrpwd);
