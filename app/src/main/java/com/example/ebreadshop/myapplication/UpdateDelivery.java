...
public class UpdateDelivery extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayDate = findViewById(R.id.DhomeDate);
        ...
        DisplayDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(UpdateDelivery.this,
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    ArrayAdapter<CharSequence> adapter = ArrayAdapter
                            .createFromResource(UpdateDelivery.this, R.array.name,
                                    android.R.layout.simple_spinner_dropdown_item);

                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spicity.setAdapter(adapter);
                    spicity.setOnItemSelectedListener(UpdateDelivery.this);
...
//                        dev.setTime(txttime.getText().toString().trim());
                    ...
                    addToDB.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(UpdateDelivery.this, R.style.MyDialogTheme);
                            ...
                            alertDialogBuilder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(UpdateDelivery.this, "You clicked over No", Toast.LENGTH_SHORT).show();
                                }
                            });
